...
setup(
    ...
    install_requires=[
        'setuptools', 'opencv-python', 'numpy',
    ],
    zip_safe=True,
    maintainer='your_name',
    maintainer_email='your_email@example.com',
    description='CV package for color detection and dropping system',
    license='MIT',
    ...
    entry_points={
        'console_scripts': [
            ...
            'dropping_real = opencv_pkg.dropping_real:main',
            'dropping_dummy = opencv_pkg.dropping_dummy:main',
